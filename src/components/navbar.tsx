...
const Navbar = async () => {
  ...
  return (
    <nav className='z-50 px-3 py-0.5 fixed lg:top-5 top-0 mx-auto left-1/2 transform -translate-x-1/2 w-full xl:w-[1200px]  shadow-lg lg:rounded-full border-1 dark:border-slate-800 backdrop-filter backdrop-blur-lg bg-opacity-50 dark:bg-main-dark-bg/50 bg-blend-color-dodge'>
