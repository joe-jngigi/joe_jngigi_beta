      ...
      <div className="dark:bg-black shadow-xl border-1 dark:border-none bg-opacity-50 backdrop-blur-md rounded-2xl p-2 w-full md:max-w-[700px]">
        <div className="dark:bg-main-dark-bg rounded-xl p-3 flex items-center justify-center flex-col">
          ...
          >
            ...
            <span className="pt-5">
              <button type="submit" className="black_btn float-right">
                Sign Up
              </button>
            </span>
          </form>
          ...
          <span className="w-full mt-5 text-14 flex flex-col sm:flex-row items-center justify-between px-4 gap-2">
            Yoooh. Have an account, we sign you in😶‍🌫️🫡
            <Link
              className="underline uppercase text-base font-semibold tracking-wider"
