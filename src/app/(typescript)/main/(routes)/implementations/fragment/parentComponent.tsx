...
const ParentComponent = ({children}: {children: React.ReactNode}) => {
  return (
    <div className=''>
      <AppHeader title='Parent Component' description='In this page we learn how we can implement a parent component to have children types' />
      {/*  */}
      <div className='dark:bg-slate-950 p-2 rounded-2xl mt-10'>
        <p>In this parent component we have the children, which are other components. In the structure of this component, 
